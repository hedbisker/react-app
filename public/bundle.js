	...
	var Weather = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(WeatherForm, { onNewData: this.handleSearch }),
	            renderMessage()
	        );
	    }
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'input',
	                    { type: 'text', placeholder: 'Enter city name', ref: 'location' },
	                    ' '
	                ),
	                React.createElement(
	                    'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_URL = 'http://api.openweathermap.org/data/2.5/weather?units=metric&APPID=86ec52afecf5fe383b480c8c7ab62a1f';
